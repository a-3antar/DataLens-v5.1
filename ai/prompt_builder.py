...
- أجب بـ SQL فقط بدون أي شرح"""
    ...
    def build_story(
        ...
        rules = (
            ...
            "3. اذكر أبرز النقاط: أعلى/أدنى قيمة، اتجاه عام، أي تفاوت لافت.\n"
            "4. اكتب بأسلوب سردي متصل (فقرات)، وليس نقاطاً متفرقة إلا عند الحاجة.\n"
            "5. أنهِ بخلاصة أو ملاحظة عملية مختصرة إن أمكن.\n"
            "6. لا تذكر أنك 'نموذج' أو تصف عملية التحليل نفسها — اكتب النتيجة مباشرة."
        )
